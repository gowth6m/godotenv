# GoDotEnv ![CI](https://github.com/gowth6m/godotenv/workflows/CI/badge.svg) [![Go Report Card](https://goreportcard.com/badge/github.com/gowth6m/godotenv)](https://goreportcard.com/report/github.com/gowth6m/godotenv)
...
```shell
go get github.com/gowth6m/godotenv
```
...
go >= 1.17
```shell
go install github.com/gowth6m/godotenv/cmd/godotenv@latest
```

go < 1.17
```shell
go get github.com/gowth6m/godotenv/cmd/godotenv
```
...
This library has been declared feature complete (see [#182](https://github.com/gowth6m/godotenv/issues/182) for background) and will not be accepting issues or pull requests adding new functionality or breaking the library API.
...
Use [annotated tags for all releases](https://github.com/gowth6m/godotenv/issues/30). Example `git tag -a v1.2.1`
